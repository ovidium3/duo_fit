...
class ExerciseData {
  ...
  static final ExerciseModel shoulderPressExercise = ExerciseModel(
      ...
      setDataList: ExerciseData()
          .generateSetDataList(3, ExerciseTexts.shoulderPress, true));
  ...
  static final ExerciseModel pullUpExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.pullUp, true));
  ...
  static final ExerciseModel inclineBenchExercise = ExerciseModel(
      ...
      setDataList: ExerciseData()
          .generateSetDataList(3, ExerciseTexts.inclineBench, true));
  ...
  static final ExerciseModel seatedRowExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.seatedRow, true));
  ...
  static final ExerciseModel lateralRaiseExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.lateralRaise));
  ...
  static final ExerciseModel tricepExtensionExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.tricepExtension));
  ...
  static final ExerciseModel bicepCurlExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.bicepCurl));
  ...
  static final ExerciseModel reverseFlyExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.reverseFly));
  ...
  static final ExerciseModel squatExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.squat, true));
  ...
  static final ExerciseModel legPressExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.legPress, true));
  ...
  static final ExerciseModel legExtensionExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.legExtension));
  ...
  static final ExerciseModel hamstringCurlExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.hamstringCurl));
  ...
  static final ExerciseModel skullcrusherExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.skullcrusher));
  ...
  static final ExerciseModel barbellCurlExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.barbellCurl));
  ...
  static final ExerciseModel legRaiseExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.legRaise));
  ...
  static final ExerciseModel kneeRaiseExercise = ExerciseModel(
      ...
      setDataList:
          ExerciseData().generateSetDataList(3, ExerciseTexts.kneeRaise));
  ...
  static final ExerciseModel russianTwistExercise = ExerciseModel(
    ...
    setDataList:
        ExerciseData().generateSetDataList(3, ExerciseTexts.russianTwist),
  );
  ...
  static final ExerciseModel crunchExercise = ExerciseModel(
      ...
      setDataList: ExerciseData().generateSetDataList(3, ExerciseTexts.crunch));
}
